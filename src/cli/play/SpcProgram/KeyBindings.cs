...
public static class KeyBindings {
	...
	public enum Action {
		...
		ZoomOut,
		SettingsMenuSelect,
		SettingsMenuSelect_1,
		SettingsMenuSelect_2,
		SettingsMenuSelect_3,
		SettingsMenuSelect_4,
		SettingsMenuSelect_5,
		SettingsMenuSelect_6,
		SettingsMenuSelect_7,
		SettingsMenuSelect_8,
		EnableFadeouts,
		DisableFadeouts,
